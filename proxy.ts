...
export default auth((request) => {
  ...
  const isCompanyManagement = request.nextUrl.pathname === "/organization/companies";
  const loginUrl = new URL(isCompanyManagement ? "/company-management/login" : "/login", request.url);
