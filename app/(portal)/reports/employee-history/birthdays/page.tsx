    ...
    <div>
      <section className="relative h-40 border-b border-border bg-[#51A0F5] p-6 text-white">
        <div className="flex h-full flex-col items-start justify-center">
          ...
          <h1 className="mt-4 text-2xl font-bold text-white">รายงานวันเกิดประจำเดือน</h1>
        </div>
      </section>
        ...
        <Card className="overflow-hidden">
          ...
          <CardContent className="px-4 pb-[15px] pt-4">
            ...
            <div className="mt-7 flex justify-end gap-2">
              <Button disabled={!searched} className="h-9 rounded-[3px] bg-[#43b14b] px-3.5 text-sm shadow-sm hover:bg-[#43b14b]/90 disabled:bg-[#a5d6a7] disabled:text-white disabled:opacity-100">Excel<Grid3x3 className="size-4" /></Button>
              <Button onClick={() => setSearched(true)} className="h-9 rounded-[3px] bg-[#1890ff] px-3.5 text-sm shadow-sm hover:bg-[#1890ff]/90">ค้นหา</Button>
            </div>
          </CardContent>
        </Card>

        <Card>
          <div className="flex h-[59px] items-center px-3"><p className="-translate-y-px text-[22px] font-bold leading-8 text-[#4d4d4d]">รายงานวันเกิดประจำเดือน</p></div>
          <CardContent className="px-2 pb-2 pt-0"><EmptyState /></CardContent>
        </Card>
      </div>
    </div>
  );
