...
import { ThaiMonthPicker, ThaiYearPicker } from "@/components/ui/thai-date-picker";
      ...
      <div className="space-y-2 bg-[#f2f5fa] p-6 pt-[31px]">
        <Card className="min-w-[1165px] overflow-hidden">
          ...
          <CardContent className="px-4 pb-[15px] pt-4">
            ...
            <div className="relative -left-[3px] mt-[27px] flex justify-end gap-2"><Button className="h-9 w-[90px] rounded-[3px] bg-[#43b14b] px-3.5 text-sm shadow-sm hover:bg-[#43b14b]/90">Excel<Grid3x3 className="size-4" /></Button><Button className="h-9 w-[65px] rounded-[3px] bg-[#1890ff] px-3.5 text-sm shadow-sm hover:bg-[#1890ff]/90">ค้นหา</Button></div>
          </CardContent>
        </Card>
        <Card className="min-w-[1165px]"><CardContent className="pb-2 pl-[7px] pr-2 pt-0"><EmptyState /></CardContent></Card>
      </div>
    </div>
  );
}
