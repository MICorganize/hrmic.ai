...
export default function ReportEmployeeNewHiresPage() {
    ...
    <div>
      <section className="relative h-40 border-b border-border bg-[#51A0F5] p-6 text-white">
        <div className="flex h-full flex-col items-start justify-center">
          ...
          <h1 className="mt-4 text-2xl font-bold text-white">รายงานพนักงานเข้าใหม่</h1>
        </div>
      </section>
        ...
        <Card className="min-w-[1163px] overflow-hidden">
          ...
          <CardContent className="px-4 pb-4 pt-4">
            ...
            <div className="mt-[27px] flex justify-end gap-2">
              ...
              <Button className="h-9 w-[90px] rounded-[3px] bg-[#43b14b] px-3.5 text-sm shadow-sm hover:bg-[#43b14b]/90">Excel<Grid3x3 className="size-4" /></Button>
