        ...
        <div className="relative flex flex-col justify-center px-7 py-6 sm:px-12">
          ...
          <div className="mb-3">
            <div className="flex h-16 items-center justify-center">
              <div className="origin-center scale-[.72] sm:scale-[.76]">
                <HRMicWordmark primaryClassName="text-[#315ff4] [text-shadow:0_0_1.5px_#1849db]" taglineClassName="mt-3 leading-none" />
              </div>
            </div>
            <h1 className="mt-1 text-2xl font-semibold text-[#333]">{copy.title}</h1>
          ...
          <form className="space-y-2" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input id="register-name" name="name" type="text" autoComplete="name" placeholder={copy.namePlaceholder} value={name} onChange={(event) => setName(event.target.value)} className="h-10 w-full rounded-xl border border-[#e0e3e7] bg-white pl-11 pr-4 text-sm text-[#353a40] outline-none transition focus:border-[#315ff4] focus:ring-1 focus:ring-[#315ff4]" required />
              </div>
            </div>
